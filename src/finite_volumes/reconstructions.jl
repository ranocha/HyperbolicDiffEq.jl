...
function interpolate!(uval, ξ, cell, u, balance_law, mesh::UniformPeriodicMesh1D,
                      reconstruction!, stencil_width::Val{1})
    # no stencils with overlap; set mean values as reconstructions
    @inbounds for idx in eachindex(uval)
        uval[idx] = u[cell]
    end
    nothing
end
...
function interpolate!(uval, ξ, cell, u, balance_law, mesh::UniformPeriodicMesh1D,
                      reconstruction, stencil_width::Val{3})
    # stencils with overlap
    @inbounds if cell == 1
        u_m1 = u[end]
        u_0  = u[cell]
        u_p1 = u[cell+1]
    elseif cell == length(u)
        u_m1 = u[cell-1]
        u_0  = u[cell]
        u_p1 = u[1]
    else
    ...
    interpolate!(uval, ξ, u_m1, u_0, u_p1, balance_law, mesh, reconstruction)

    nothing
end

function interpolate!(uval, ξ, cell, u, balance_law, mesh::UniformPeriodicMesh1D,
                      reconstruction, stencil_width::Val{5})
    # stencils with overlap
    @inbounds if cell == 1
        u_m2 = u[end-1]
        u_m1 = u[end]
    ...
    interpolate!(uval, ξ, u_m2, u_m1, u_0, u_p1, u_p2, balance_law, mesh, reconstruction)

    nothing
end

function interpolate!(uval, ξ, cell, u, balance_law, mesh::UniformPeriodicMesh1D,
                      reconstruction, stencil_width::Val{7})
    # stencils with overlap
    @inbounds if cell == 1
        u_m3 = u[end-2]
        u_m2 = u[end-1]
    ...
    interpolate!(uval, ξ, u_m3, u_m2, u_m1, u_0, u_p1, u_p2, u_p3, balance_law, mesh, reconstruction)

    nothing
end

function interpolate!(uval, ξ, cell, u, balance_law, mesh::UniformPeriodicMesh1D,
                      reconstruction, stencil_width::Val{9})
    # stencils with overlap
    @inbounds if cell == 1
        u_m4 = u[end-3]
        u_m3 = u[end-2]
    ...
    interpolate!(uval, ξ, u_m4, u_m3, u_m2, u_m1, u_0, u_p1, u_p2, u_p3, u_p4, balance_law, mesh, reconstruction)

    nothing
end

function interpolate!(uval, ξ, cell, u, balance_law, mesh::UniformPeriodicMesh1D,
                      reconstruction, stencil_width::Val{11})
    # stencils with overlap
    @inbounds if cell == 1
        u_m5 = u[end-4]
        u_m4 = u[end-3]
    ...
    interpolate!(uval, ξ, u_m5, u_m4, u_m3, u_m2, u_m1, u_0, u_p1, u_p2, u_p3, u_p4, u_p5, balance_law, mesh, reconstruction)

    nothing
end

function interpolate!(uval, ξ, cell, u, balance_law, mesh::UniformPeriodicMesh1D,
                      reconstruction, stencil_width::Val{13})
    # stencils with overlap
    @inbounds if cell == 1
        u_m6 = u[end-5]
        u_m5 = u[end-4]
    ...
    interpolate!(uval, ξ, u_m6, u_m5, u_m4, u_m3, u_m2, u_m1, u_0, u_p1, u_p2, u_p3, u_p4, u_p5, u_p6, balance_law, mesh, reconstruction)

    nothing
end

function interpolate!(uval, ξ, cell, u, balance_law, mesh::UniformPeriodicMesh1D,
                      reconstruction, stencil_width::Val{15})
    # stencils with overlap
    @inbounds if cell == 1
        u_m7 = u[end-6]
        u_m6 = u[end-5]
    ...
    interpolate!(uval, ξ, u_m7, u_m6, u_m5, u_m4, u_m3, u_m2, u_m1, u_0, u_p1, u_p2, u_p3, u_p4, u_p5, u_p6, u_p7, balance_law, mesh, reconstruction)
